...
#
# Versi ini tidak butuh perubahan di Supabase.
# Harga diambil via bulk fetch (date >= lookback_days) dengan order global:
#   symbol ASC, date DESC, updated_on DESC
# lalu dipilih baris pertama per symbol sebagai "terbaru".
# Simbol sumber pertama kali diambil dari company_map.json (dibuat via 'refresh' / 'bootstrap').
