...
from src.parser.archive.utils.pdf_tables import extract_table_like
from src.parser.archive.company.service import CompanyService
...
def _prefer_price_from_line(line: str) -> Optional[str]:
    ...
    for m in tokens:
        ...
        is_candidate = (
            ...
            _RE_BIG_INT.fullmatch(t)         # 1.370 / 2.000 / 1,485
