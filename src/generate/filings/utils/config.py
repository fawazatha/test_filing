...
# P0-5 • Recompute ownership % (model vs PDF -> flag, do not override)
...
# (Gating implementation is in send_alerts.py; this variable is only a list of reasons that gate)
GATE_REASONS = set(
